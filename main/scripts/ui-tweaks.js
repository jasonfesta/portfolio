(function () {
  ...
  function normalizeBrandAndIntro() {
    ...
    var introCopy = [
      "Currently designing Darwin — multiplayer AI networks for brands, creators, & consumers.",
      "My work sits at the intersection of AI, media, & new networks — usually wherever two or three of those threads meet.",
